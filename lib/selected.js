...
//if more than one is selected, return null;
var getSingleSelected = function (el) {
	var elSelected = getSelected(el, true);
	return (elSelected instanceof Array) ? ((elSelected.length === 1) ? elSelected[0] : null) : elSelected;
}
